    ...
    <div class="mat-card">
      ...
      <div class="mat-card-body">
        ...
        <div style="margin-top:.9rem;display:flex;gap:.5rem;flex-wrap:wrap;">
          <a href="<?= $U ?>modulos/academico/informes/ver.php?matricula=<?= $m['id'] ?>" target="_blank"
            ...
            <i class="bi bi-file-earmark-text-fill"></i> Informe acad&eacute;mico
          </a>
          <a href="<?= $U ?>docente/informe_pdf.php?matricula=<?= $m['id'] ?>" target="_blank"
             style="display:inline-flex;align-items:center;gap:.4rem;padding:.5rem 1.1rem;background:#fff;color:var(--orange);border:1.5px solid var(--orange);border-radius:10px;font-size:.8rem;font-weight:700;text-decoration:none;">
            <i class="bi bi-file-earmark-person-fill"></i> Hoja de vida
          </a>
        </div>
      </div>
    </div>
