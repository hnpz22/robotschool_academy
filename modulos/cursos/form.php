...
if ($id) {
    ...
    $curso = $stmt->fetch();
    if (!$curso) {
        header('Location: ' . $U . 'modulos/cursos/index.php'); exit;
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        header('Location: ' . $U . 'modulos/cursos/index.php?msg=' . ($curso ? 'editado':'creado'));
        exit;
    }
}
  ...
  <div class="header-title">
    ...
    <small>
      <span class="breadcrumb-rsal">
        <a href="<?= $U ?>modulos/cursos/index.php">Cursos</a>
    ...
    <div style="display:grid;grid-template-columns:1fr 320px;gap:1.4rem;align-items:start;">
      ...
      <div>
        ...
        <div class="card-rsal">
          ...
          <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:.5rem;margin-bottom:.8rem;" id="galGrid">
            ...
            <div style="position:relative;border-radius:8px;overflow:hidden;" id="gal_<?= $gi['id'] ?>">
              ...
              <a href="<?= $U ?>modulos/cursos/galeria_eliminar.php?id=<?= $gi['id'] ?>&curso=<?= $id ?>"
        ...
        <div class="card-rsal">
          ...
          <a href="<?= $U ?>modulos/cursos/index.php" class="btn-rsal-secondary"
