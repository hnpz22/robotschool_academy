...
if ($id) {
    ...
    if (!$rubrica) { header('Location:'.$U.'modulos/rubricas/index.php'); exit; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        header('Location:'.$U.'modulos/rubricas/index.php?msg='.($rubrica?'editada':'creada'));
        exit;
    }
}
...
<header class="main-header">
  <div class="header-title">
    ...
    <small><span class="breadcrumb-rsal">
      <a href="<?= $U ?>modulos/rubricas/index.php">R&uacute;bricas</a>
    ...
    <div style="display:grid;grid-template-columns:1fr 300px;gap:1.4rem;align-items:start;">
      ...
      <div>
        ...
        <div class="card-rsal">
          ...
          <a href="<?= $U ?>modulos/rubricas/index.php" class="btn-rsal-secondary"
