...
<header class="main-header">
  ...
  <a href="<?= $U ?>modulos/rubricas/form.php" class="btn-rsal-primary">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:1rem;">
      ...
      <div class="card-rsal" style="margin:0;transition:all .2s;"
        ...
        <div style="display:flex;gap:.5rem;">
          <a href="<?= $U ?>modulos/rubricas/form.php?id=<?= $r['id'] ?>"
             class="btn-rsal-primary" style="flex:1;justify-content:center;padding:.5rem;">
            <i class="bi bi-pencil-fill"></i> Editar
          </a>
          <a href="<?= $U ?>modulos/evaluaciones/index.php?rubrica=<?= $r['id'] ?>"
...
<form id="fEl" method="POST" action="<?= $U ?>modulos/rubricas/eliminar.php">
