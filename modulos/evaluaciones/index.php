...
<header class="main-header">
  ...
  <a href="<?= $U ?>modulos/evaluaciones/form.php" class="btn-rsal-primary">
          ...
          <tr>
            ...
            <td>
              <div style="display:flex;gap:.4rem;">
                <a href="<?= $U ?>modulos/evaluaciones/form.php?id=<?= $ev['id'] ?>"
...
<form id="fEl" method="POST" action="<?= $U ?>modulos/evaluaciones/eliminar.php">
