...
if ($id) {
    ...
    if (!$evaluacion) { header('Location:'.$U.'modulos/evaluaciones/index.php'); exit; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        header('Location:'.$U.'modulos/evaluaciones/index.php?msg='.($evaluacion?'editada':'creada'));
        exit;
    }
}
...
<header class="main-header">
  <div class="header-title">
    ...
    <small><span class="breadcrumb-rsal">
      <a href="<?= $U ?>modulos/evaluaciones/index.php">Evaluaciones</a>
    ...
    <div style="display:grid;grid-template-columns:1fr 320px;gap:1.4rem;align-items:start;">
      ...
      <div>
        ...
        <div class="card-rsal">
          ...
          <a href="<?= $U ?>modulos/evaluaciones/index.php" class="btn-rsal-secondary"
...
function cargarCriterios() {
  ...
  fetch('<?= $U ?>modulos/evaluaciones/criterios_ajax.php?rubrica_id=' + rubId)
    .then(r => r.json())
    .then(data => {
