...
if ($id) {
    ...
    if (!$grupo || ($sede_filtro && $grupo['sede_id'] != $sede_filtro)) {
        header('Location: '.$U.'modulos/grupos/index.php'); exit;
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        header('Location: '.$U.'modulos/grupos/index.php?msg='.($grupo?'editado':'creado'));
        exit;
    }
}
  ...
  <div class="header-title">
    ...
    <small>
      <span class="breadcrumb-rsal">
        <a href="<?= $U ?>modulos/grupos/index.php">Grupos</a>
    ...
    <div style="display:grid;grid-template-columns:1fr 320px;gap:1.4rem;align-items:start;">
      ...
      <div>
        ...
        <div class="card-rsal">
          ...
          <a href="<?= $U ?>modulos/grupos/index.php" class="btn-rsal-secondary"
