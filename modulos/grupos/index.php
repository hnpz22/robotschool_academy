...
<header class="main-header">
  ...
  <a href="<?= $U ?>modulos/grupos/form.php" class="btn-rsal-primary">
          ...
          <tr>
            ...
            <td>
              <div style="display:flex;gap:.4rem;">
                <a href="<?= $U ?>modulos/grupos/form.php?id=<?= $g['id'] ?>"
...
<form id="fEl" method="POST" action="<?= $U ?>modulos/grupos/eliminar.php">
